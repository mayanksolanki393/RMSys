angular.module('userApp').controller("AddChildRequirementController",["$scope","$uibModal","$routeParams","RequirementService",function($scope,$uibModal,$routeParams,requirementService){
	...
	$scope.add = function(){
		requirementService.addNewChildRequirement($scope.addReq)
