/*angular.module("empApp").controller("MisCtrl",["$scope","$uibModal","EmployeeService",function($scope,$uibModal,empService){
	$scope.emp = {};
...
angular.module("empApp").controller("UserCtrl",["$scope","$filter","EmployeeService",function($scope,$filter,empService){
	$scope.emps = [];
	$scope.temp = {};
	$scope.search = {
		searchFor:"",	
